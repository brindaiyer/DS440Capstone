...
print(train_file_features.columns)
...
#round(100 * (TP + TN) / len(y_test), 2)
accuracy = round((100 * ((df_cm.iloc[1,1] + df_cm.iloc[0,0]) / len(result))), 2)
print("Test Accuracy:", accuracy, "%") #[1,1] [0,0]
