...
####
##### train the model
validationmodel = model.fit(x_train, y_train, validation_data=(x_val, y_val), batch_size=25, epochs = 1) #epochs stands for how many times you go through training set
