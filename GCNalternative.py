...
prueba_0=cleaned_df[cleaned_df['Class']==2] # 1) Split "2" Class array 
prueba_0
####
prueba_1=cleaned_df[cleaned_df['Class']==1] # 1) Split "1" Class array 
prueba_1
####
prueba=cleaned_df[cleaned_df['Class']=="unknown"]  # 2) Split Class array "unknown"
prueba
##
...
vertical #has tx_id
#230425980,5530478,232022460,230460314,230459870
...
#print(train_x) #size 117903
#print(val_x) #size 39302
#print(len(train_y)) #117903
#print(len(val_y)) #39302
...
#print(rep_x) #len 19720 rows, 50 columns
#print(rep_y) #len 19720 
#print(len(y_n))#4000
#print(len(y_f))#15720
...
print(len(pred_y)) #19720
 #6067 rows each


submission = pd.DataFrame({
        "txId": [val_x[i][0] for i in range(len(val_x))],
        "Class": pred_y 
    })

#matrix = [val_x[i][0] for i in range(len(val_x))]
##val_x = val_x.tolist()
##print(val_x)
##pred_y = pred_y.tolist()
##print(pred_y)
##finalresult = pd.DataFrame(columns=['txId','class'])
##for i in range(len(pred_y)):
##    finalresult.loc[finalresult.shape[0]] = [0,0]
##    finalresult[i,0] = val_x[i][0]
##    finalresult[i,1] = pred_y[i]


submission.to_csv(r'C:\Users\brind\Documents\DS440\EvolveGCN\data\elliptic_bitcoin_dataset\Autoencoder1.csv', index = None, header=True)

#how the files was created in R
#test<-as.matrix(test)
